-- Revert to simpler approach - the trigger shouldn't call the webhook
-- Instead, we'll create a new edge function specifically for sending confirmation emails
-- that can be called both from webhook and from trigger
