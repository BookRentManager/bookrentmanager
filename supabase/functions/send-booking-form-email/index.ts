      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div style="text-align: center;">
            <a href="${formUrl}" class="button" style="display: inline-block; padding: 14px 24px; background: #000000; color: #C5A572; text-decoration: none; border-radius: 8px; font-weight: 700; font-size: 16px; margin: 20px auto; border: 3px solid #C5A572; box-shadow: 0 4px 20px rgba(197, 165, 114, 0.4); text-transform: uppercase; letter-spacing: 1px; max-width: 280px;">Complete Booking Form ✨</a>
          </div>
