...
export default function Reports() {
  ...
  // Fetch all financial data with booking details
  ...
  // Fetch bookings for status breakdown
  ...
  // Fetch payments for cash flow analysis
  ...
  // Fetch expenses for cash flow analysis
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-8">
        <h3 className="text-2xl font-bold tracking-tight mb-4">Financial Reports</h3>
