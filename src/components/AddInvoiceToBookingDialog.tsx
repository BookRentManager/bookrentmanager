...
interface AddInvoiceToBookingDialogProps {
  bookingId: string;
  defaultCarPlate?: string;
}

export function AddInvoiceToBookingDialog({ bookingId, defaultCarPlate }: AddInvoiceToBookingDialogProps) {
  ...
  const addInvoiceMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Invoice added to booking");
      form.reset();
      setOpen(false);
    },
    onError: (error) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>Add Invoice to This Booking</DialogTitle>
        </DialogHeader>
        <Form {...form}>
