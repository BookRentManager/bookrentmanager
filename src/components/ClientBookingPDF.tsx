  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Payment Information - NO SUPPLIER PRICE */}
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            <Text style={styles.label}>VAT ({Number(booking.vat_rate)}%):</Text>
            <Text style={styles.value}>€{((Number(booking.rental_price_gross) * Number(booking.vat_rate)) / 100).toFixed(2)}</Text>
          </View>
          <View style={styles.row}>
